...
const JourneySection = () => {
  const journeyMilestones = [
    {
      year: "2025",
      title: "Founder & Pioneering Quantitative AI Governance",
      description: "Founder and CEO of SANJEEVANI AI. Built METRIS-Quantitative AI Governance Platform, the first platform to quantify AI governance risk in dollars, with 1,500+ assessments across 50+ jurisdictions. Built DeLARSify, a multi-modal AI platform for cancer patients with LARS. Obtained ISO/IEC 42001 Lead Auditor certification. Selected for Washington University CELect-STL program. Accepted into Founder Institute Core. Delivering AI Governance Awareness and Literacy Training for enterprises preparing for EU AI Act compliance.",
      highlight: true
    },
    {
      year: "2022-2024",
      title: "Senior AI Consultant",
      description: "Delivered enterprise AI solutions at First American with $5M annual savings and Centene with $500M+ compliance savings. Led global teams and implemented Responsible AI frameworks. Published cancer research on Oxaliplatin effects accepted by ASCO. Began building METRIS-Quantitative AI Governance Platform and DeLARSify.",
    },
    {
      year: "2018-2021",
