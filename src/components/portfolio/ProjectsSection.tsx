...
const ProjectsSection = () => {
  const projects = [
    {
      title: "METRIS-Quantitative AI Governance Platform",
      description: "The first platform to quantify AI governance risk in dollars. Employs 17 specialized AI agents evaluating systems against 1,481 checkpoints spanning 50+ jurisdictions including EU AI Act, NIST AI RMF, and ISO/IEC 42001. In production with 1,500+ assessments analyzing 43,000+ documents achieving 0.89 correlation with expert judgment. Features Bayesian scoring, Monte Carlo risk simulation, and ensemble time series forecasting.",
      tags: ["AI Governance", "Multi-Agent Systems", "EU AI Act", "Risk Quantification", "Bayesian Inference", "Compliance"],
      status: "Production",
