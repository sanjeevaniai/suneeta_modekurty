...
import suneetaProfile from "@/assets/suneeta-profile-latest.jpeg";
        ...
        <div className="mb-12 animate-fade-in">
          ...
          <div className="mb-8 flex justify-center">
            <Avatar className="w-32 h-32 md:w-40 md:h-40 border-4 border-primary/20 shadow-elegant">
              <AvatarImage src={suneetaProfile} alt="Suneeta Modekurty" className="object-cover" />
          ...
          <h1 className="mb-8 text-foreground font-light">
            ...
            />
            <span className="block text-2xl md:text-3xl text-muted-foreground">Pioneering the Future of Technology</span>
          </h1>
