    ...
    >
      <div className="space-y-8">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            <strong className="text-foreground">METRIS-Quantitative AI Governance Platform</strong> is the first platform to quantify AI governance risk in dollars, not adjectives. Employing 17 specialized AI agents, METRIS-Quantitative AI Governance Platform evaluates systems against 1,481 checkpoints spanning 50+ jurisdictions including the EU AI Act, NIST AI RMF, and ISO/IEC 42001. In production, the platform has completed 1,500+ assessments analyzing 43,000+ documents with 0.89 correlation to expert judgment.
          </p>
