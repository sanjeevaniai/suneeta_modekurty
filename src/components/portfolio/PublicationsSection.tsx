...
const PublicationsSection = () => {
  const publications = [
    {
      title: "METRIS-Quantitative AI Governance Platform: A 17-Agent Multi-Modal Framework for Quantitative AI Governance Assessment",
      journal: "Zenodo",
      date: "2025",
      type: "Preprint",
      description: "Presents METRIS-Quantitative AI Governance Platform, a comprehensive platform transforming qualitative governance assessments into quantitative intelligence through a novel multi-agent architecture.",
